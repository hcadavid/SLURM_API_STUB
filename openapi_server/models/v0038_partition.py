...
class V0038Partition(Model):
    ...
    def __init__(self, flags=None, preemption_mode=None, allowed_allocation_nodes=None, allowed_accounts=None, allowed_groups=None, allowed_qos=None, alternative=None, billing_weights=None, default_memory_per_cpu=None, default_time_limit=None, denied_accounts=None, denied_qos=None, preemption_grace_time=None, maximum_cpus_per_node=None, maximum_memory_per_node=None, maximum_nodes_per_job=None, max_time_limit=None, min_nodes_per_job=None, name=None, nodes=None, over_time_limit=None, priority_job_factor=None, priority_tier=None, qos=None, state=None, total_cpus=None, total_nodes=None, tres=None, maximum_memory_per_cpu=None, default_memory_per_node=None):  # noqa: E501
        """V0038Partition - a model defined in OpenAPI
