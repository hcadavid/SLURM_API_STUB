...
class V0038License(Model):
    ...
    """
    def __init__(self, license_name: str=None, total: int=None, used: int=None, free: int=None, reserved: int=None, remote: bool=None):  # noqa: E501
        """V0038License - a model defined in Swagger
