...
from swagger_server.models.v0038_reservation_purge_completed import V0038ReservationPurgeCompleted  # noqa: F401,E501
...
class V0038Reservation(Model):
    ...
    """
    def __init__(self, accounts: str=None, burst_buffer: str=None, core_count: int=None, core_spec_cnt: int=None, end_time: int=None, features: str=None, flags: List[str]=None, groups: str=None, licenses: str=None, max_start_delay: int=None, name: str=None, node_count: int=None, node_list: str=None, partition: str=None, purge_completed: V0038ReservationPurgeCompleted=None, start_time: int=None, watts: int=None, tres: str=None, users: str=None):  # noqa: E501
        """V0038Reservation - a model defined in Swagger
