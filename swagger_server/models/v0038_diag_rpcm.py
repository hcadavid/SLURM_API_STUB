...
class V0038DiagRpcm(Model):
    ...
    """
    def __init__(self, message_type: str=None, type_id: int=None, count: int=None, average_time: int=None, total_time: int=None):  # noqa: E501
        """V0038DiagRpcm - a model defined in Swagger
