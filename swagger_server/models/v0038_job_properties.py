...
class V0038JobProperties(Model):
    ...
    """
    def __init__(self, account: str=None, account_gather_frequency: str=None, argv: List[str]=None, array: str=None, batch_features: str=None, begin_time: int=None, burst_buffer: str=None, cluster_constraint: str=None, comment: str=None, constraints: str=None, container: str=None, core_specification: int=None, cores_per_socket: int=None, cpu_binding: str=None, cpu_binding_hint: str=None, cpu_frequency: str=None, cpus_per_gpu: str=None, cpus_per_task: int=None, current_working_directory: str=None, deadline: str=None, delay_boot: int=None, dependency: str=None, distribution: str=None, environment: object=None, exclusive: str=None, get_user_environment: bool=None, gres: str=None, gres_flags: str=None, gpu_binding: str=None, gpu_frequency: str=None, gpus: str=None, gpus_per_node: str=None, gpus_per_socket: str=None, gpus_per_task: str=None, hold: bool=None, kill_on_invalid_dependency: bool=None, licenses: str=None, mail_type: str=None, mail_user: str=None, mcs_label: str=None, memory_binding: str=None, memory_per_cpu: int=None, memory_per_gpu: int=None, memory_per_node: int=None, minimum_cpus_per_node: int=None, minimum_nodes: bool=None, name: str=None, nice: int=None, no_kill: bool=None, nodes: List[int]=None, open_mode: str='append', oversubscribe: bool=False, partition: str=None, prefer: str=None, priority: str=None, qos: str=None, requeue: bool=None, reservation: str=None, signal: str=None, sockets_per_node: int=None, spread_job: bool=None, standard_error: str=None, standard_input: str=None, standard_output: str=None, tasks: int=None, tasks_per_core: int=None, tasks_per_node: int=None, tasks_per_socket: int=None, thread_specification: int=None, threads_per_core: int=None, time_limit: int=None, time_minimum: int=None, wait_all_nodes: bool=None, wckey: str=None):  # noqa: E501
        """V0038JobProperties - a model defined in Swagger
