...
from swagger_server.models.v0038_node import V0038Node  # noqa: F401,E501
...
class V0038NodesResponse(Model):
    ...
    """
    def __init__(self, meta: V0038Meta=None, errors: List[V0038Error]=None, nodes: List[V0038Node]=None):  # noqa: E501
        """V0038NodesResponse - a model defined in Swagger
