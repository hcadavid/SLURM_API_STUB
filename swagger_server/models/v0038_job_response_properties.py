...
from swagger_server.models.v0038_job_resources import V0038JobResources  # noqa: F401,E501
...
class V0038JobResponseProperties(Model):
    ...
    """
    def __init__(self, account: str=None, accrue_time: int=None, admin_comment: str=None, array_job_id: int=None, array_task_id: int=None, array_max_tasks: int=None, array_task_string: str=None, association_id: int=None, batch_features: str=None, batch_flag: bool=None, batch_host: str=None, flags: List[str]=None, burst_buffer: str=None, burst_buffer_state: str=None, cluster: str=None, cluster_features: str=None, command: str=None, comment: str=None, container: str=None, contiguous: bool=None, core_spec: str=None, thread_spec: str=None, cores_per_socket: str=None, billable_tres: float=None, cpus_per_task: str=None, cpu_frequency_minimum: str=None, cpu_frequency_maximum: str=None, cpu_frequency_governor: str=None, cpus_per_tres: str=None, deadline: int=None, delay_boot: int=None, dependency: str=None, derived_exit_code: int=None, eligible_time: int=None, end_time: int=None, excluded_nodes: str=None, exit_code: int=None, features: str=None, federation_origin: str=None, federation_siblings_active: str=None, federation_siblings_viable: str=None, gres_detail: List[str]=None, group_id: int=None, job_id: int=None, job_resources: V0038JobResources=None, job_state: str=None, last_sched_evaluation: int=None, licenses: str=None, max_cpus: int=None, max_nodes: int=None, mcs_label: str=None, memory_per_tres: str=None, name: str=None, nodes: str=None, nice: int=None, tasks_per_core: int=None, tasks_per_socket: int=None, tasks_per_board: int=None, cpus: int=None, node_count: int=None, tasks: int=None, het_job_id: int=None, het_job_id_set: str=None, het_job_offset: int=None, partition: str=None, memory_per_node: int=None, memory_per_cpu: int=None, minimum_cpus_per_node: int=None, minimum_tmp_disk_per_node: int=None, preempt_time: int=None, pre_sus_time: int=None, priority: int=None, profile: List[str]=None, qos: str=None, reboot: bool=None, required_nodes: str=None, requeue: bool=None, resize_time: int=None, restart_cnt: int=None, resv_name: str=None, shared: str=None, show_flags: List[str]=None, sockets_per_board: int=None, sockets_per_node: int=None, start_time: int=None, state_description: str=None, state_reason: str=None, standard_error: str=None, standard_input: str=None, standard_output: str=None, submit_time: int=None, suspend_time: int=None, system_comment: str=None, time_limit: int=None, time_minimum: int=None, threads_per_core: int=None, tres_bind: str=None, tres_freq: str=None, tres_per_job: str=None, tres_per_node: str=None, tres_per_socket: str=None, tres_per_task: str=None, tres_req_str: str=None, tres_alloc_str: str=None, user_id: int=None, user_name: str=None, wckey: str=None, current_working_directory: str=None):  # noqa: E501
        """V0038JobResponseProperties - a model defined in Swagger
