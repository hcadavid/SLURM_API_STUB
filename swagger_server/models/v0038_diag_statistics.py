...
from swagger_server.models.v0038_diag_rpcm import V0038DiagRpcm  # noqa: F401,E501
from swagger_server.models.v0038_diag_rpcu import V0038DiagRpcu  # noqa: F401,E501
...
class V0038DiagStatistics(Model):
    ...
    """
    def __init__(self, parts_packed: int=None, req_time: int=None, req_time_start: int=None, server_thread_count: int=None, agent_queue_size: int=None, agent_count: int=None, agent_thread_count: int=None, dbd_agent_queue_size: int=None, gettimeofday_latency: int=None, schedule_cycle_max: int=None, schedule_cycle_last: int=None, schedule_cycle_total: int=None, schedule_cycle_mean: int=None, schedule_cycle_mean_depth: int=None, schedule_cycle_per_minute: int=None, schedule_queue_length: int=None, jobs_submitted: int=None, jobs_started: int=None, jobs_completed: int=None, jobs_canceled: int=None, jobs_failed: int=None, jobs_pending: int=None, jobs_running: int=None, job_states_ts: int=None, bf_backfilled_jobs: int=None, bf_last_backfilled_jobs: int=None, bf_backfilled_het_jobs: int=None, bf_cycle_counter: int=None, bf_cycle_mean: int=None, bf_cycle_max: int=None, bf_last_depth: int=None, bf_last_depth_try: int=None, bf_depth_mean: int=None, bf_depth_mean_try: int=None, bf_cycle_last: int=None, bf_queue_len: int=None, bf_queue_len_mean: int=None, bf_table_size: int=None, bf_table_size_mean: int=None, bf_when_last_cycle: int=None, bf_active: bool=None, rpcs_by_message_type: List[V0038DiagRpcm]=None, rpcs_by_user: List[V0038DiagRpcu]=None):  # noqa: E501
        """V0038DiagStatistics - a model defined in Swagger
